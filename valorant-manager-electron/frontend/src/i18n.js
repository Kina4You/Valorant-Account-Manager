...
const en = {
  ...
  "nav.noFriends": "NO FRIENDS YET",
  "nav.selectFriend": "SELECT A FRIEND",
  "nav.firstFriend": "+ ADD YOUR FIRST FRIEND",
  "nav.remove": "REMOVE",
  "friend.addTitle": "ADD FRIEND",
  "friend.addText": "Enter their Riot ID. Only public data is loaded — rank, RR and match history.",
  "friend.label": "RIOT ID",
  "friend.ph": "Name#TAG",
  "friend.needHash": "Please enter it as Name#TAG.",
  "friend.removeTitle": "REMOVE FRIEND?",
  "friend.removeText": "will be removed from your friends list.",
  "toast.friendAdded": "Friend added",
  "toast.friendRemoved": "Friend removed",
  "toast.syncAllDone": "Sync finished: {ok} of {n} successful",
  "auto.label": "AUTO SYNC ON START",
  "auto.hintTitle": "Auto sync on start",
  "auto.hint1": "Every time the app starts, all accounts and friends are synced one after another.",
  "auto.hint2": "Pro: rank and RR are always up to date without clicking anything.",
  "auto.hint3": "Con: the start takes a moment longer, and each sync uses up part of your Henrik API limit. With many accounts you may hit the limit.",
  "auto.on": "ON",
  "auto.off": "OFF",
  "auto.textOn": "All accounts and friends are synced when the app starts.",
  "auto.textOff": "Nothing is synced automatically.",
  ...
  "account.deleteText": "will be deleted permanently.",
  ...
  "backend.friend_invalid": "Please enter it as Name#TAG.",
  "backend.friend_exists": "This friend is already on your list.",
...
const de = {
  ...
  "nav.friends": "FREUNDE",
  "nav.addFriend": "+ FREUND HINZUFÜGEN",
  "nav.noFriends": "NOCH KEINE FREUNDE",
  "nav.selectFriend": "FREUND AUSWÄHLEN",
  "nav.firstFriend": "+ ERSTEN FREUND HINZUFÜGEN",
  "nav.remove": "ENTFERNEN",
  "friend.addTitle": "FREUND HINZUFÜGEN",
  "friend.addText": "Gib die Riot-ID ein. Geladen werden nur öffentliche Daten — Rang, RR und Match-Verlauf.",
  "friend.label": "RIOT-ID",
  "friend.ph": "Name#TAG",
  "friend.needHash": "Bitte als Name#TAG eingeben.",
  "friend.removeTitle": "FREUND ENTFERNEN?",
  "friend.removeText": "wird aus deiner Freundesliste entfernt.",
  "toast.friendAdded": "Freund hinzugefügt",
  "toast.friendRemoved": "Freund entfernt",
  "toast.syncAllDone": "Sync fertig: {ok} von {n} erfolgreich",
  "auto.label": "AUTO-SYNC BEIM START",
  "auto.hintTitle": "Auto-Sync beim Start",
  "auto.hint1": "Bei jedem Start der App werden alle Accounts und Freunde nacheinander synchronisiert.",
  "auto.hint2": "Vorteil: Rang und RR sind immer aktuell, ohne dass du etwas klicken musst.",
  "auto.hint3": "Nachteil: Der Start dauert etwas länger, und jeder Sync verbraucht einen Teil deines Henrik-API-Limits. Bei vielen Accounts kann das Limit erreicht werden.",
  "auto.on": "AN",
  "auto.off": "AUS",
  "auto.textOn": "Beim Start werden alle Accounts und Freunde synchronisiert.",
  "auto.textOff": "Es wird nichts automatisch synchronisiert.",
  ...
  "account.deleteText": "wird unwiderruflich gelöscht.",
  ...
  "backend.friend_invalid": "Bitte als Name#TAG eingeben.",
  "backend.friend_exists": "Dieser Freund ist schon in deiner Liste.",
